            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#05101E] mb-6 leading-tight">
                        Leadership Built on <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C19A6B] to-amber-500">Three Pillars</span>
                    </h2>
                    ...
                    {pillars.map((pillar, index) => (
                        ...
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <h3 className="text-2xl font-bold text-[#05101E] mb-4 font-serif group-hover:text-[#C19A6B] transition-colors duration-300">
                                    {pillar.title}
                                </h3>
