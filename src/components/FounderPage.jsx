    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <section className="relative min-h-screen flex items-center overflow-hidden">
                {/* Background */}
                <div className="absolute inset-0 bg-gradient-to-br from-[#0a1628] via-[#05101E] to-[#0A1F3D]">
                        ...
                        <div className="lg:w-1/2 relative">
                            <div className="relative max-w-md mx-auto">
                                ...
                                <div className="relative aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl">
                                    ...
                                    />
                                    {/* Gradient Overlay */}
                                    <div className="absolute inset-0 bg-gradient-to-t from-[#05101E]/80 via-transparent to-transparent"></div>
                                </div>
                                ...
                                <div className="absolute -bottom-6 -left-6 bg-white rounded-2xl p-6 shadow-2xl">
                                    <p className="text-2xl font-bold text-[#05101E]">Joshua Tolofari</p>
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#05101E]/5 rounded-full mb-6">
                            <BookOpen className="w-4 h-4 text-[#05101E]" />
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative z-10 p-8">
                                ...
                                <h3 className="text-xl font-bold text-[#05101E] mb-4">The Problem</h3>
                        ...
                        <div className="relative group">
                            ...
                            <div className="relative z-10 p-8">
                                ...
                                <h3 className="text-xl font-bold text-[#05101E] mb-4">The Insight</h3>
                                <p className="text-gray-600 leading-relaxed">
                    ...
                    <div className="mt-16 text-center">
                        <div className="max-w-3xl mx-auto bg-gradient-to-r from-[#05101E] to-[#0A1F3D] rounded-3xl p-10 relative overflow-hidden">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {speakingTopics.map((topic, index) => (
                            ...
                            >
                                ...
                                <h3 className="text-xl font-bold text-[#05101E] mb-3">{topic.title}</h3>
            ...
            <section className="py-24 px-6 bg-gray-50 relative overflow-hidden">
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#05101E]/5 rounded-full mb-6">
                            <Award className="w-4 h-4 text-[#05101E]" />
            ...
            <section id="contact" className="py-32 px-6 bg-gradient-to-br from-[#D2B48C] via-[#C19A6B] to-[#b8962e] relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            href="/contact"
                            className="group inline-flex items-center gap-4 px-12 py-6 bg-white text-[#05101E] font-bold text-xl rounded-2xl transition-all duration-300 shadow-2xl hover:shadow-white/25 transform hover:-translate-y-1 hover:scale-105"
                        >
                        ...
                        <a
                            href="/services/speaking"
                            className="group inline-flex items-center gap-4 px-12 py-6 bg-transparent border-2 border-white text-white font-bold text-xl rounded-2xl transition-all duration-300 hover:bg-white hover:text-[#05101E]"
                        >
