...
export default function HeroNavBar({ showHero = false }) {
  ...
  return (
    <div className={`relative w-full ${showHero ? 'min-h-screen' : ''} overflow-hidden bg-[#0a1628]`}>
      {/* Background Elements - Only show if showHero is true, or maybe always? 
          If showHero is false, the container height is 0, so these won't show anyway unless we give it height.
          Let's keep them but they will be hidden if container is 0 height.
      */}
      {showHero && (
        <>
