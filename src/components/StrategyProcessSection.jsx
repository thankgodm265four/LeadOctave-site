    ...
    const processCards = [
        {
            ...
            image: '/image/leader-office.jpg'
        },
        {
            letter: 'B',
            label: 'Implement Streamlined Procedures',
            image: '/image/diverse-team.jpg'
        },
        {
            letter: 'C',
            label: 'Incorporate Automation Solutions',
            image: '/image/staff-analyzing.jpg'
        }
    ];
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
                    {processCards.map((card, index) => (
                        ...
                        >
                            ...
                            {/* Gradient Overlay */}
                            <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent group-hover:from-[#05101E]/90 transition-all duration-500"></div>
