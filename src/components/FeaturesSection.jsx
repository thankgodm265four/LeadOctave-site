    ...
    return (
        <section className="py-24 px-6 bg-gradient-to-b from-gray-50 to-white relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/2 w-[800px] h-[800px] -translate-x-1/2 -translate-y-1/2 bg-gradient-to-br from-[#D2B48C]/5 to-transparent rounded-full blur-3xl"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="text-center mb-20">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#D2B48C]/10 rounded-full mb-6">
                        ...
                        <span className="text-sm font-bold text-[#D2B48C] uppercase tracking-wider">Why LeadOctave</span>
                    </div>
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-[#05101E] mb-6">
                        The Leadership System <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D2B48C] to-amber-500">Advantage</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            {/* Content */}
                            <h3 className="text-xl font-bold text-[#05101E] mb-3 group-hover:text-[#D2B48C] transition-colors">
                                {feature.title}
                            </h3>
