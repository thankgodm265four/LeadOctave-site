    ...
    return (
        <div className="min-h-screen bg-white">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        <div className="lg:w-1/2">
                            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#D4A259]/20 backdrop-blur-sm rounded-full border border-[#D4A259]/30 mb-8">
                                <BookOpen className="w-4 h-4 text-[#D4A259]" />
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-[1.1] mb-8">
                                ...
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4A259] to-amber-400">Think & Act</span>
                            </h1>
                            ...
                            <div className="flex flex-wrap gap-4">
                                <a
                                    href="#contact"
                                    className="group inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-[#D4A259] to-amber-500 text-white font-bold rounded-xl transition-all duration-300 shadow-2xl shadow-[#D4A259]/30 hover:shadow-[#D4A259]/50 hover:scale-105"
                                >
                                    Book Training
                            ...
                            <div className="mt-12 flex items-center gap-6">
                                <div className="flex -space-x-3">
                                    {[1, 2, 3, 4].map((i) => (
                                        <div key={i} className="w-10 h-10 rounded-full bg-gradient-to-br from-[#D4A259] to-amber-500 border-2 border-white/20"></div>
                                    ))}
                                </div>
                                <div>
                        ...
                        <div className="lg:w-1/2 relative">
                            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-white/10 rounded-2xl p-6 text-center">
                                        <p className="text-4xl font-bold text-[#D4A259] mb-2">94%</p>
                            ...
                            {/* Decorative Elements */}
                            <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-[#D4A259] to-amber-500 rounded-2xl flex items-center justify-center shadow-xl rotate-12">
            ...
            <section className="py-24 px-6 bg-white relative overflow-hidden">
                <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#D4A259]/5 rounded-full blur-3xl"></div>
                ...
                <div className="max-w-6xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#142C4C] mb-6">
                            Targeted Workshops & <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4A259] to-amber-500">Training</span>
                        </h2>
                        ...
                        {solutions.map((solution, index) => (
                            <div key={index} className="group relative">
                                ...
                                <div className="relative z-10 p-8">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#D4A259] to-amber-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 group-hover:rotate-6 transition-all duration-500">
            ...
            {/* Closing CTA */}
            <section className="py-32 px-6 bg-gradient-to-br from-[#D4A259] via-amber-500 to-orange-500 relative overflow-hidden">
                ...
                <div className="max-w-4xl mx-auto text-center relative z-10">
                    ...
                    <a
                        href="#contact"
                        className="group inline-flex items-center gap-4 px-14 py-6 bg-white text-[#D4A259] font-bold text-xl rounded-2xl transition-all duration-300 shadow-2xl hover:shadow-white/25 transform hover:-translate-y-1 hover:scale-105"
                    >
                        Book Your Workshop
