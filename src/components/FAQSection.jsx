            ...
            <div className="max-w-4xl mx-auto relative z-10">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#C19A6B]/10 rounded-full mb-6">
                        <HelpCircle className="w-4 h-4 text-[#C19A6B]" />
                        <span className="text-sm font-bold text-[#C19A6B] uppercase tracking-wider">FAQ</span>
                    </div>
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#05101E] mb-6">
                        Frequently Asked <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#C19A6B] to-amber-500">Questions</span>
                    </h2>
                    ...
                    {faqs.map((faq, index) => (
                        <div
                            ...
                            className={`bg-white rounded-2xl shadow-sm border transition-all duration-300 overflow-hidden ${openIndex === index
                                    ? 'border-[#C19A6B] shadow-lg shadow-[#C19A6B]/10'
                ...
                <div className="text-center mt-12 p-8 bg-gradient-to-r from-[#05101E] to-[#0A1F3D] rounded-3xl">
                    ...
                    <a
                        href="/contact"
                        className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-[#C19A6B] to-[#A07855] text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 shadow-lg"
                    >
                        Contact Us
                    </a>
                </div>
