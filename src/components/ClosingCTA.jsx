...
export default function ClosingCTA() {
    return (
        <div id="score" className="w-full relative overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/4 w-32 h-32 bg-[#05101E]/10 rounded-full blur-2xl animate-float" style={{ animationDelay: '4s' }}></div>
            ...
            <div className="relative z-10 py-32 md:py-40 px-6">
                <div className="max-w-5xl mx-auto text-center">
                    ...
                    <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-10 leading-tight drop-shadow-lg">
                        Your Leadership <br />
                        <span className="text-[#05101E]">Deserves a System</span>
                    </h2>
                    ...
                    <a
                        href="/contact"
                        className="group inline-flex items-center gap-4 bg-white text-[#05101E] px-14 py-6 rounded-2xl font-bold text-xl transition-all duration-300 shadow-2xl hover:shadow-white/25 transform hover:-translate-y-1 hover:scale-105 relative overflow-hidden"
                    >
                        <span className="relative z-10">Begin Your Clarity Path</span>
                        <ArrowRight className="w-6 h-6 relative z-10 group-hover:translate-x-2 transition-transform" />
                        <div className="absolute inset-0 bg-gradient-to-r from-[#05101E] to-[#0A1F3D] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
