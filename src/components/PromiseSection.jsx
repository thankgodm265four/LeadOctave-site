...
export default function PromiseSection() {
    return (
        <div className="w-full bg-[#0a1628] py-32 md:py-40 px-6 relative overflow-hidden">
            ...
            {/* Animated Background */}
            <div className="absolute inset-0 bg-gradient-to-br from-[#0a1628] via-[#142C4C] to-[#0a1628]"></div>
            ...
            {/* Floating Orbs */}
            <div className="absolute top-20 left-20 w-72 h-72 bg-[#D4A259]/10 rounded-full blur-3xl animate-float"></div>
            ...
            <div className="max-w-5xl mx-auto text-center relative z-10">
                ...
                <h2 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-white mb-10 leading-[1.1]">
                    ...
                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4A259] via-[#e8c547] to-[#D4A259]">It's Architecture.</span>
                </h2>
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 pt-16 border-t border-white/10">
                    <div className="text-center">
                        <p className="text-4xl md:text-5xl font-bold text-[#D4A259] mb-2">93%</p>
                        <p className="text-gray-400">Leadership Clarity Improvement</p>
                    </div>
                    <div className="text-center">
                        <p className="text-4xl md:text-5xl font-bold text-[#D4A259] mb-2">2.5x</p>
                        <p className="text-gray-400">Team Performance Increase</p>
                    </div>
                    <div className="text-center">
                        <p className="text-4xl md:text-5xl font-bold text-[#D4A259] mb-2">85%</p>
